...
<Container
        ...
        >
            ...
            <Grid item xs={12}>
                field status (Tabs and internal header)
            </Grid>
            <Grid item xs={12}>
                Growth stage (Can add stage, or go to timeline)
            </Grid>
            <Grid item xs={12}>
                Weather
            </Grid>
            <Grid item xs={12}>
                Tasks (Show upcoming tasks, max 3 as card. Quick button for harvest/plant)
            </Grid>
            <Grid item xs={12}>
                Notes
            </Grid>
