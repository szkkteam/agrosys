...
const CropRoutes = ({
    ...
    return (
        <>
            <HashRoute path={VIEW_MODULE} component={props => <CropModuleLayout height={height} {...props} />} />
            <HashRoute path={VIEW_LIST} component={props => <CropModuleLayout height={height} {...props} />} />
...
CropSummaryLayout.propTypes = {

}

export default CropSummaryLayout
