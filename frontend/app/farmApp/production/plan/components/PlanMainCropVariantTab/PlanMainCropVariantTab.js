...
const PlanMainCropVariantTab = ({
    ...
    const columns = [
        ...
        {title: 'Weed', render: (rowData) => <SearchSelectComponent name="cropType"
                                                //label={intl.formatMessage(messages.cropType)}
...
PlanMainCropVariantTab.propTypes = {

}

export default PlanMainCropVariantTab