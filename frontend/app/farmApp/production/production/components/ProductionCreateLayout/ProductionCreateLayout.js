...
import { PRODUCTION_PLAN_SELECTOR_DIALOG } from 'site/modalTypes'
...
import { PlanLayout } from 'farmApp/production/plan/components'
import { FieldSideSelector } from 'farmApp/production/field/components'
...
const ProductionCreateLayout = ({
    ...
    const openPlanSelector = () => {
        push(PRODUCTION_PLAN_SELECTOR_DIALOG, {}).then((status) => {
