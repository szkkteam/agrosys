...
} from 'farmApp/cropProduction/fieldProduction/pages'
...
export const ROUTES = {
    ...
    CropProductionFieldProductionView: 'CropProductionFieldProductionView',
}
 ...
 */
  ...
  */
export const fieldProductionOverview = [
    {
        // TODO: Season components
        key: ROUTES.CropProductionFieldProductionView,
        path: '/fields',
        component: FieldProductionOverview,
